...
session_start();
  ...
  header("location:../login/"); //di tendang ke /login
  exit;
}
?>
<?php
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" onclick="return confirm('yakin ingin keluar?');" href="">Log Out</a></button>
    </form>
  </div>
</nav>
<div class="jumbotron jumbotron-fluid">
  ...
  <form role="form" action="index.php" method="POST">
   ...
   <th><input type="text" name="cari" class="form-control" placeholder="Pencarian"></th> <th><button type="submit" class="btn btn-info btn-block">Search</button></th>
     </tr></div>
</div>
</div>
  </form>
