...
<div class="col-lg-6">
  <form>
    <div class="from-group">
      ...
      <tr><th><br><input type="text" name="nisn" class="form-control" placeholder="NISN"></</th></tr>
    </div>
    <div class="from-group">
      <tr><th><br><input type="text" name="nama" class="form-control" placeholder="Nama"></th></tr>
    </div>
    <div class="from-group">
      <tr><th><br><input typle="text" name="kelas" class="form-control" placeholder="Kelas"></th></tr>
    </div>
    <div class="from-group">
      <tr><th><br><input type="text" name="jurusan" class="form-control" placeholder="Jurusan" ></th></tr>
    </div>
<div class="from-group">
