...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" href="">Log Out</a></button>
    </form>
  </div>
</nav>
<div class="jumbotron jumbotron-fluid">
  ...
  <form role="form" action="indexb.php" method="POST">
   <div class="container text-center">
   ...
   <th><input type="text" name="query" class="form-control" placeholder="Pencarian"></th> <th><button type="submit" class="btn btn-info btn-block">Search</button></th>
     </tr></div>
</div>
</div>
  </form>
...
<div class="table-responsive">
    <table class="table table-bordered table-striped table-hover">
      ...
      <tbody>
    <?php
    echo"<b>Hasil pencarian : ".$query."</b>";
  if($query != ''){
    $result = mysqli_query($mysqli,"SELECT * FROM users WHERE nisn LIKE'%".$query."%' OR nama LIKE '%".$query."%' ");
